...
<div class="w3-display-topright" ><form method="post" >
  ...
  ?>
    ...
    <div class="container">
        ...
        // select all data
        $query = "SELECT id, title, singer, year, link, lyrics FROM othermusic ORDER BY id DESC";
        ...
        echo "<a href='create3.php' class='btn btn-primary m-b-1em'>Add new song</a>";
            ...
            echo "<table class='table table-hover table-responsive table-bordered'>";//start table
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                    ...
                    echo "<tr>";
                        ...
                        echo "<td>";
                            // read one record
                            echo "<a href='read_one3.php?id={$id}' class='btn btn-info m-r-1em'>View</a>";

                            // we will use this links on next part of this post
                            echo "<a href='update3.php?id={$id}' class='btn btn-primary m-r-1em'>Edit</a>";
...
function delete_user( id ){
    ...
    if (answer){
        ...
        window.location = 'delete3.php?id=' + id;
    }
