...
<body>
<a href='index.php' class='btn btn-danger'><i class="fa fa-angle-double-left" style="font-size:36px"></i></a>
    <!-- container -->
    <div class="container">
    ...
    if($_POST){
        ...
        try{
            ...
            // insert query
            $query = "INSERT INTO engmusic SET title=:title, singer=:singer, year=:year, link=:link, lyrics=:lyrics";
