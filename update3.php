...
<body>
  <a href='index3.php' class='btn btn-danger' ><i class="fa fa-angle-double-left" style="font-size:36px"></i></a>
    <!-- container -->
    <div class="container">
       ...
       try {
           ...
           $query = "SELECT id, title, singer, year, link, lyrics FROM othermusic WHERE id = ? LIMIT 0,1";
