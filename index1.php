...
<div class="w3-display-topright" ><form method="post" >
  ...
  ?>
    ...
    <div class="container">
        ...
        // select all data
        $query = "SELECT id, title, singer, year, link, lyrics FROM malaymusic ORDER BY id DESC";
        ...
        echo "<a href='create1.php' class='btn btn-primary m-b-1em'>Add new song</a>";
            ...
            echo "<table class='table table-hover table-responsive table-bordered'>";//start table
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                    ...
                    echo "<tr>";
                        ...
                        echo "<td>";
                            // read one record
                            echo "<a href='read_one1.php?id={$id}' class='btn btn-info m-r-1em'>View</a>";
